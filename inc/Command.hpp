...
class Command{
    ...
    public:
        ...
        virtual void Execute(std::shared_ptr<Client> client, std::vector<std::string> tokens) = 0;
};
...
class PingCommand : public Command{
    public:
        ...
        void Execute(std::shared_ptr<Client> client, std::vector<std::string> tokens);
};
